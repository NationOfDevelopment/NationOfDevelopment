...
public class StoreController {
    ...
    public ApiResponse<StoreResponseDto> deleteStore(@PathVariable Long storeId, @Auth AuthUser authUser){

        StoreResponseDto storeResponseDto = storeService.deleteStore(storeId, authUser);
        return ApiResponse.onSuccess(storeResponseDto);
    }
